...
Two middleware functions are provided by default in the `item-bookmark.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `item-bookmark.handler` namespace to manage the enabled middleware.
